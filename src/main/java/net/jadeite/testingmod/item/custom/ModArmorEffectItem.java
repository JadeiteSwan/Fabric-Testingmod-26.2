...
public class ModArmorEffectItem extends Item {

    // Add effect to full set of armor
    private static final Map<ArmorMaterial, List<MobEffectInstance>> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, List<MobEffectInstance>>())
                    .put(ModArmorMaterials.CHEESE_ARMOR_MATERIAL,
    ...
    public ModArmorEffectItem(Properties properties) {
        super(properties);
    }
